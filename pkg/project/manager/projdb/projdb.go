...
func New(dbUsername, dbPassword, dbHost string, dbPort int, dbName string) project.ProjectManager {
	return &manager{dbUsername: dbUsername, dbPassword: dbPassword, dbHost: dbHost, dbName: dbName, dbPort: dbPort}
}

func (pm *manager) GetProject(ctx context.Context, projectName string) (*project.Project, error) {
	var (
		owner string
		path  string
	)
...
func (pm *manager) GetAllProjects(ctx context.Context) ([]*project.Project, error) {
